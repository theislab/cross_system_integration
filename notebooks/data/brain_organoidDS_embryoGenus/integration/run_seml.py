...
def run(eval_type:str, script_dir:str=None, model:str=None, name:str=None, seed_num:str=None, 
        ...
        batch_key:str=None,use_batch_key:str=None, cells_eval:str=None, genes_eval:str=None, 
    ...
    script=f'{script_dir}run_{eval_type}{model_fn_part}.py'  
